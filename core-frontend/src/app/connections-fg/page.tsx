...
const logoPath = "/icons/cw.svg"; // Path to your logo SVG file

// Controllable parameters for button link
const buttonHref = "/connections"; // Change this to your desired link (internal: "/page" or external: "https://example.com")
...
export default function Page() {
  ...
  return (
    <div className={`min-h-screen bg-[#7D3D65] relative overflow-hidden ${rubik.variable} ${yuseiMagic.variable}`}>
