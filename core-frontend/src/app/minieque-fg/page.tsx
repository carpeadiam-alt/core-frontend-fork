...
const logoPath = "/icons/miniesque-w.svg"; // Path to your logo SVG file

// Controllable parameters for button link
const buttonHref = "https://thecodeworks.in/coreTries/exolve-player.html"; // Change this to your desired link (internal: "/page" or external: "https://example.com")
...
export default function Page() {
  ...
  return (
    <div className={`min-h-screen bg-green-800 relative overflow-hidden ${rubik.variable} ${yuseiMagic.variable}`}>
