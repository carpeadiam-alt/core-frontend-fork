...
const logoPath = "/icons/pnw.svg"; // Path to your logo SVG file

// Controllable parameters for button link
const buttonHref = "/punchline"; // Change this to your desired link (internal: "/page" or external: "https://example.com")
...
export default function Page() {
  ...
  const svgPath = "/fores/pnfg.svg"; // Path to your SVG file
  
  // Check if the link is external
  const isExternalLink = buttonHref.startsWith('http://') || buttonHref.startsWith('https://') || buttonHref.startsWith('//');
  
  return (
    <div className={`min-h-screen bg-[#FACA0A] relative overflow-hidden ${rubik.variable} ${yuseiMagic.variable}`}>
