...
const logoSize = 110;
const logoPath = '/icons/hs-w.svg';

// Controllable parameters for button link
const buttonHref = 'https://thecodeworks.in/coreTries/hopscotch.html';
...
export default function Page() {
  ...
  const svgPath = '/fores/hs-fg.svg';

  return (
    <div
      className={`min-h-screen bg-[#E7FF49] relative overflow-hidden ${rubik.variable} ${yuseiMagic.variable}`}
    >
